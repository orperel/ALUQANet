...
def create_nabert_drop_reader(data_split='dev'):
    ...
    if data_split == 'dev':
        ...
        data_path = "/home/itaysofer/Desktop/Drop/data/drop_dataset_dev.json"
    elif data_split == 'train':
        # data_path = "/specific/netapp5_2/gamir/advml19/perel/Drop/data/drop_dataset/drop_dataset_train.json"
        data_path = "/home/itaysofer/Desktop/Drop/data/drop_dataset_train.json"
    else:
...
pickle.dump(instances, open("./pickled_data/drop_dataset_train.pickle", "wb+"))

instances = create_nabert_drop_reader('dev')
pickle.dump(instances, open("./pickled_data/drop_dataset_dev.pickle", "wb+"))
